...
const Permissions = Object.seal(Object.freeze(Object.preventExtensions({
	...
	// Bits that can be set by BO/system for staff on /manage
	_MANAGE_BOARD_BITS: [ 30,31,32,33,34,35,36, ],
...
const Metadata = Object.seal(Object.freeze(Object.preventExtensions({
	...
	[Permissions.MANAGE_GLOBAL_TRUSTED]: { label: 'Trusted', desc: 'Access trusted list. Ability to edit trusted users' },
