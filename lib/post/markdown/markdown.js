...
const updateMarkdownPerms = () => {
	replacements = [
		{ permission: Permissions.USE_MARKDOWN_GENERAL, regex: rainbowtextRegex, cb: (permissions, match, rainbowtext) => `<span class='rainbow'>${rainbowtext}</span>` },
		{ permission: Permissions.USE_MARKDOWN_GENERAL, regex: glowtextRegex, cb: (permissions, match, glowtext) => `<span class='glowtext'>${glowtext}</span>` },
		{ permission: Permissions.USE_MARKDOWN_GENERAL, regex: orangetextRegex, cb: (permissions, match, orangetext) => `<span class='orangetext'>&lt;${orangetext}</span>` },
		{ permission: Permissions.USE_MARKDOWN_GENERAL, regex: greentextRegex, cb: (permissions, match, greentext) => `<span class='greentext'>&gt;${greentext}</span>` },
		...
		{ permission: Permissions.USE_MARKDOWN_GENERAL, regex: titleRegex, cb: (permissions, match, title) => `<span class='title'>${title}</span>` },
		{ permission: Permissions.USE_MARKDOWN_GENERAL, regex: bluetextRegex, cb: (permissions, match, bluetext) => `<span class='bluetext'>${bluetext}</span>` },
