...
module.exports = async (req, res, next) => {
	...
	const captchaInput = req.body.captcha || req.body['g-recaptcha-response'] || req.body['h-captcha-response'] || req.body['cf-turnstile-response'];
	...
	if (!['turnstile', 'google', 'hcaptcha', 'yandex']
		.includes(captchaOptions.type)) {
